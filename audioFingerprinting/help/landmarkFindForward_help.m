%% landmarkFindForward
% Landmarks finding forward for audio fingerprinting
%% Syntax
% * 		[landmarkVec, specMat_opt, threshold, peakTable, specMat] = landmarkFindForward(y, fs, afpPrm)
%% Description
%
% <html>
...
afpPrm=afpOptSet;
[landmarkVec, specMat, threshold, peakTable]=landmarkFindForward(y, fs, afpPrm, 1);
%% See Also
% <queryMatchIncremental_help.html queryMatchIncremental>.
